...
export const storeClusterQueryData = (
...
export const SET_DeployedOFFunc = (
  clusterId: string | undefined,
...
export const GET_DeployedOFFunc = (
...
export const DEL_DeployedOFFunc = (
  clusterId: string | undefined,
  deployedFunctions: DeployedFunctionTypes[]
) => ({
